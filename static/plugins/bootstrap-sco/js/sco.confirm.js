...
;(function($, undefined) {
	...
	function Confirm(options) {
		...
		if (!$modal.length) {
			...
			'			<a href="#" class="btn btn-danger btn-sm" data-action="1" id="uiBoxYeapBtn">确定</a> '+
			'			<a class="btn btn-primary btn-sm cancel" href="#" data-dismiss="modal" id="uiBoxCancellBtn">取消</a>'+
			'		</div>'+
			'   </div>'+
			'  </div>'+
			'</div>';
